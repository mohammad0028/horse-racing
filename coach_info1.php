...
<link href="css/coach_info1.css" rel="stylesheet" type="text/css">
</head>
...
<a href="horse_info1.php"><input type="button" value="اسب ها" class="info13"></a>
<a href="coach_info1.php"><input type="button" value="مربی ها" class="info2"></a>
<a href="rider_info1.php"><input type="button" value="چابکسوار ها" class="info13"></a>
</div>
</div>
