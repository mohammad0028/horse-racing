jQuery(document).ready(function() {
  ...
  $("#personal_change").click(function(event) {
    ...
    $.ajax({
      url: 'checkpersonal_retailer.php',
      type: 'POST',
      cache: false,
...
(function ($) {
  ...
  $("#company_change").click(function(event) {
    ...
    $.ajax({
      url: 'changecompany_retailer.php',
      type: 'POST',
      cache: false,
...
$(document).ready(function (e) {
  $("#uploadimage").on('submit',(function(e) {
    ...
    // $('#loading').show();
    $.ajax({
      url: "change_image_retailer.php", // Url to which the request is send
