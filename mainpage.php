...
<img src="images/az.PNG" id="logo">
</div>

<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="mainpage.php"><span class="nav-content" style="color:#FBFBFB;font-size:25px;">صفحه اصلی</span></a>&nbsp;
    </div>
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#"> <span class="caret"></span>&nbsp;<span class="nav-content">جداول و نتایج</span></a>
       <ul class="dropdown-menu" style="direction:rtl;">
          <li><a href="race_chart.php" class="dropdown-a">جدول مسابقات</a></li>
          <li><a href="race_result.php" class="dropdown-a">نتایج مسابقات</a></li>
        </ul>
       </li> 
      <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#"><span class="caret"></span><span class="nav-content">گالری</span> </a>
        <ul class="dropdown-menu" style="direction:rtl;">
          <li><a href="pic_gallery.php" class="dropdown-a">گالری عکس</a></li>
          <li><a href="video_gallery.php" class="dropdown-a">گالری فیلم</a></li>
        </ul>
      </li>
      <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#"><span class="caret"></span>&nbsp;<span class="nav-content">سابقه و عملکرد</span></a>
        <ul class="dropdown-menu" style="direction:rtl;">
          <li><a href="horse_info.php" class="dropdown-a">اطلاعات اسب ها</a></li>
          <li><a href="coach_info.php" class="dropdown-a">اطلاعات مربی ها</a></li>
          <li><a href="rider_info.php" class="dropdown-a">اطلاعات چابک سوارها</a></li>
        </ul>
      </li>
      <!--<li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#"> <span class="caret"></span>&nbsp;<span class="nav-content">پیش بینی</span></a>
       ...
       <li><a href="sabtenam.php"><span class="glyphicon glyphicon-user"></span><span class="nav-content"> ثبت نام</span></a></li>
       <li><a href="vorood.php"><span class="glyphicon glyphicon-log-in"></span> <span class="nav-content">ورود</span></a></li>
    ...
    <ul class="nav navbar-nav navbar-left"> 
      ...
      <form id="search-form_3">
		...
		<input type="submit" class="submit_3" value="جستجو" />
	  </form>
      </li>-->
