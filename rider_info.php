...
<link href="css/rider_info.css" rel="stylesheet" type="text/css">
...
<a href="horse_info.php"><input type="button" value="اسب ها" class="info12"></a>
<a href="coach_info.php"><input type="button" value="مربی ها" class="info12"></a>
<a href="rider_info.php"><input type="button" value="چابکسوار ها" class="info3"></a>
</div>
</div>
