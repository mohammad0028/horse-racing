...
<head>
<meta charset="utf-8">
<title>گالری فیلم ها</title>
<meta name="viewport" content="width=device-width, initial-scale=1">
<link rel="stylesheet" href="bootstrap/dist/css/bootstrap-rtl.min.css">
<link href="css/video_gallery.css" rel="stylesheet" type="text/css">
	...
	if(mysqli_num_rows($result2)>0){
		...
		while($info=mysqli_fetch_assoc($result2)){
			...
			echo "
				...
				<div class='col-md-4'>	
					<video width='374' height='290' class='video' controls style='display:inline;'>
